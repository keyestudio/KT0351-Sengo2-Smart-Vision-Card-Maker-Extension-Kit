...
1. In the code start-up, set pins (that control motors) to output mode, and then set the communication mode of the AI vision module to `I2C`, and set it to run in `Blob` mode.
