...
In this project, let’s play Jan-Ken Punch (also called Rock, Paper, Scissors, or Janken). Herein, we replace these gestures with labels of 16h5, including 0(Rock), 1(Scissors) and 2(Paper), to compete with the car. The car will randomly generate one of these three numbers. Rock beats scissors, scissors beat paper, and paper beats rock. If the car wins, it will take a step forward; if it loses, it will take a step back.
