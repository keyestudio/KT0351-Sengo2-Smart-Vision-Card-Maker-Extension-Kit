...
| :--------: | :------------------------------------------: | :-----: |
|   1 (x)    | Central coordinate x of the recognition area |   50    |
|   2 (y)    | Central coordinate y of the recognition area |   50    |
|   3 (w)    |       Width w of the recognition area        |    3    |
|   4 (h)    |       Height h of the recognition area       |    4    |
|     5      |                     none                     |    /    |
