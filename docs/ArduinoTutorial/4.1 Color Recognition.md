...
| :-------: | :------------------------------------------: | :-----: |
|     1     | Central coordinate x of the recognition area |   50    |
|     2     | Central coordinate y of the recognition area |   50    |
|     3     |       Width w of the recognition area        |    3    |
|     4     |       Height h of the recognition area       |    4    |
|     5     |                     none                     |    /    |
...
| :--------------: | :--------------------------------------------: |
|   1 (kRValue)    |  red component value R, with a range of 0-255  |
|   2 (kGValue)    | green component value G, with a range of 0-255 |
|   3 (kBValue)    | blue component value B, with a range of 0-255  |
|        4         |                      none                      |
|    5 (kLabel)    |               color label value                |
