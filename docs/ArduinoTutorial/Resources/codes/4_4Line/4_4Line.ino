...
// Communication method (currently enabled I2C). Suitable for UNO, Nano, ESP32 development boards
#define SENGO_I2C

// Communication method (currently enabled I2C). Suitable for Pico
// #define Pico_I2C

// Communication method (currently enabled I2C). Suitable for UNO，Nano，ESP32
// #define SENGO_UART
...
//Pico I2C
  ...
  Wire.begin();  // Initialize the I2C bus
  // Keep trying to connect until you succeed
  while (SENTRY_OK != sengo.begin(&Wire)) {
    yield();  // Allow other tasks to run while waiting
  }
#endif
