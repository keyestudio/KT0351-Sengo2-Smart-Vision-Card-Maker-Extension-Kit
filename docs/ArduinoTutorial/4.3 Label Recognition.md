...
|            Mode            | Tag label |
| :------------------------: | :-------: |
| 0 (kVisionModeFamily16H5)  | Tag 16H5  |
| 1 (kVisionModeFamily25H9)  | Tag 25H9  |
| 2 (kVisionModeFamily36H11) | Tag 36H11 |
...
| :--------------: | :------------------------: |
|   1 (kXValue)    | label central coordinate x |
|   2 (kYValue)    | label central coordinate y |
| 3 (kWidthValue)  |       label width w        |
| 4 (kHeightValue) |       label height h       |
|    5 (kLabel)    |          label ID          |
