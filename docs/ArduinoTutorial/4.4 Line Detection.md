...
| Parameter |                          Definition                          |
| :-------: | :----------------------------------------------------------: |
|     1     | x-coordinate of the end point (distal end) of the line segment |
|     2     | y-coordinate of the end point (distal end) of the line segment |
|     3     | x-coordinate of the starting point (proximal end) of the line segment |
|     4     | y-coordinate of the starting point (proximal end) of the line segment |
|     5     |            inclination angle of the line segment             |
